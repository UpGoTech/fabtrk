...
frappe.query_reports["FT Drawing Part"] = {
	...
	// 					project_numbers: project_numbers.length ? JSON.stringify(project_numbers) : null  // ✅ NEW
	// 				},
	// 				callback: function (r) {
	...
	// 					// ✅ Full layout — OUTSIDE datatable, neeche alag section
	// 					let html = `
	...
	//                         <!-- Table: sticky header + scroll body + sticky footer -->
	//                         <div style="border:1px solid #dee2e6; border-radius:4px; overflow:hidden;">

	//                             <!-- STICKY HEADER -->
	//                             <div style="overflow:hidden; background:#1F4E79;">
	//                                 <table class="table table-bordered" style="margin:0; font-size:12px; table-layout:fixed; width:100%; border-bottom:none;">
	//                                     ${colgroup}
	...
	//                                 <table class="table table-bordered table-hover" style="margin:0; font-size:12px; table-layout:fixed; width:100%;">
	//                                     ${colgroup}
	...
	//                             <!-- STICKY FOOTER -->
	//                             <div style="overflow:hidden; border-top:2px solid #1F4E79; background:#f0f4ff; box-shadow:0 -2px 5px rgba(0,0,0,0.07);">
	//                                 <table class="table table-bordered" style="margin:0; font-size:12px; table-layout:fixed; width:100%; border-top:none;">
	//                                     ${colgroup}
	//                                     <tbody>${footer_html}</tbody>
	//                                 </table>
	//                             </div>
	...
	// 					// ✅ report.wrapper ke BAHAR append karo — datatable ke neeche alag section
						...
						let html = `
							<div id="item-detail-container" style="margin-top:24px; padding:16px 20px 20px 20px; border:1px solid #ddd; border-radius:6px; background:#fff;">
								...
								<div style="border:1px solid #dee2e6; border-radius:4px; overflow:hidden;">
									...
									<!-- SCROLLABLE BODY -->
									<div style="overflow-y:auto; max-height:420px; overflow-x:auto;">
										<table class="table table-bordered table-hover" style="margin:0; font-size:12px; table-layout:fixed; width:100%;">
											${colgroup}
											<tbody>${body_rows_html}</tbody>
										</table>
