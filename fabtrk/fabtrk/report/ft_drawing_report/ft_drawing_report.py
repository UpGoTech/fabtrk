...
def execute(filters=None):
    ...
    columns = [
        ...
        {"label": "Drawing Number", "fieldname": "drawing_number", "fieldtype": "Link", "options": "FT Add Drawing", "width": 200},
        {"label": "PO Serial No", "fieldname": "po_serial_no", "fieldtype": "Int", "width": 190},
	...
	if filters.get("project_number"):
		conditions += " AND pod.project_number IN %(project_number)s"
    ...
    # ---------- SUMMARY ----------
    total_projects = len(set([d["project_number"] for d in data if d["project_number"]!="TOTAL"]))
    total_drawings = len(set([d["drawing_number"] for d in data if d["drawing_number"]]))
    total_lines = len([d for d in data if d["po_serial_no"]])
    ...
    report_summary = [
        {
            ...
            <div class="summary-container">
                ...
                <div class="summary-section">
                    <div class="section-content-count">
                        <p>Total Weight (Kg)</p>
                        <span>{round(total_weight,3)}</span>
                    </div>
                </div>
